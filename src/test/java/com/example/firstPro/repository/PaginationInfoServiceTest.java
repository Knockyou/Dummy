...
import com.example.firstPro.dto.PaginationInfo;
import com.example.firstPro.service.PaginationInfoService;
...
public class PaginationInfoServiceTest {
    ...
    void check(PaginationInfo paginationInfo, int firstPage, int prevPage, int startPage, int currentPage,
               int endPage, int nextPage, int lastPage, int totalPageCount){
    ...
    void getPaginationInfo01() {
        PaginationInfo paginationInfo = paginationInfoService.getPaginationInfo(1,1,5,1);
